...
int main(int argc, char *argv[])
{
    ...
    g_object_set(G_OBJECT (rtcpsrc), "port", 5005, NULL);
    g_object_set(G_OBJECT (rtcpsrc), "caps", gst_caps_from_string("application/x-rtcp"), NULL);
    ...
    // g_object_set(G_OBJECT(sink), "host", "10.42.0.56", "port", 5000, NULL);
